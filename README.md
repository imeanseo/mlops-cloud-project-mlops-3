...
graph TB
    ...
    C --> D[MySQL Database]
    D --> E[Model Training<br/>ItemCF Epoch=10]
    D --> F[Airflow Pipeline<br/>Batch Serving]
    E --> G[WandB Monitoring]
    E --> H[S3 Model Storage<br/>v1, v2...v7]
    F --> I[MySQL Results<br/>Pre-computed]
    H --> J[FastAPI Server<br/>Real-time API]
    I --> J
    J --> K[Web Interface<br/>webapp.py]
